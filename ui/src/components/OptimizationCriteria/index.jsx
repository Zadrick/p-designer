...
const OptimizationCriteria = observer(() => {
    ...
    // const { criteriaList, setCriteriaList } = useStore('mainStore')
    ...
    const deleteCriteria = index => {
        setCriteriaList(criteriaList.filter((item, i) => i !== index))
    }
            ...
            <div className="optimization__criteria_content">
                ...
                {criteriaList.map((item, i) => (
                    <div key={i} className="optimization__criteria_item">
                        ...
                        <div className="optimization__criteria_type">Maximization</div>
                        <div className="optimization__criteria_max">2.0</div>
                        <div className="optimization__criteria_min">1.0</div>
                        <div className="optimization__criteria_target">1.5</div>
                        <div onClick={() => deleteCriteria(i)} className="optimization__criteria_delete">
